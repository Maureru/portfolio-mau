...
function ProjectCard({
  ...
  return (
    <div className="overflow-hidden hover:shadow-md hover:shadow-[#b96a59]/50 hover:dark:shadow-[#c58d69]/50 transition-all w-[100%] grid grid-cols-1 sm:grid-cols-2  sm:h-auto xl:h-80 bg-zinc-200 shadow-md dark:bg-zinc-800 rounded-[1rem]">
      <div
