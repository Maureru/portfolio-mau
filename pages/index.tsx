...
export default function Home() {
  ...
  return (
    <div className='overflow-hidden lg:overflow-visible' /* data-theme={theme} */>
      <Head>
      ...
      <main className='sm:block block lg:flex xl:flex'>
        ...
        <div  className='top-0 w-screen lg:w-[40%] z-50 lg:z-[99] h-auto lg:h-[100vh] mt-20 lg:mt-0 relative lg:sticky px-4 sm:px-8 xl:px-16 flex font-sans items-center'>
          <motion.div variants={stagger} initial="initial" animate="animate" className='relative z-50'>
            <motion.p variants={fadeInUp}  className='text-md mb-2'>Ohh you found me? Howdy! I am</motion.p>
            <motion.h2 variants={fadeInUp}  className='segoe text-5xl font-bold'>{profile.firstName}</motion.h2>
            <motion.h1 variants={letterSpace}  className='segoe leading-[70px] text-7xl sm:text-9xl lg:text-7xl xl:text-8xl text-[#b96a59] dark:text-[#c58d69] font-bold '>{profile.secondName}.</motion.h1>
...
I am a software engineer freelancer based in the Philippines.</motion.p>
        ...
        <div className=' relative h-[100%] w-[100%]  lg:w-[60%] '>
          <div className='h-auto w-[100%] my-8 xl:my-0 lg:h-[100vh] flex justify-center items-center relative overflow-hidden'>
            <motion.div className='z-[60]' variants={hero} initial="initial" animate="animate" >
            <Image src={profile.image} alt="avatar" height={700} width={700}/>
            </motion.div>
            
            <motion.h1 variants={rotateProfession} initial="initial" animate="animate" className='select-none absolute z-0 text-[#b96a59]/50 dark:text-[#c58d69]/50 text-[6rem] sm:text-[10rem] lg:text-[11rem] font-bold rotate-[-30deg]'>DEVELOPER</motion.h1>
          </div>
          ...
          <div className='mt-5 px-4  h-auto xl:h-[100vh] block xl:flex items-center'>
            <div className='w-[100%] xl:w-[60%] '>
              ...
              <div className='mt-6 flex flex-col gap-4'>
                <div className='grid grid-cols-2'>
                  <ul className='flex flex-col gap-3 '>
                   {Skills.slice(0,4).map((skill, i) => (
                    <li className='flex gap-2 text-sm' key={i}><Icon className='w-6 h-6 text-[#b96a59] dark:text-[#c58d69]' as={skill.icon}/>{skill.name}</li>
                   ))}
                ...
                <p onClick={handleModalOpen} className='flex items-center gap-1 text-sm cursor-pointer'>See my full arsenal <RiShareBoxFill/></p>
              </div>
            </div>
            <div className='xl:w-[40%] w-[100%] flex items-center justify-center'>
              <Image src={profile.logo} alt="crown" height={200} width={200}/>
            </div>
          </div>
          </FadeVisible>
